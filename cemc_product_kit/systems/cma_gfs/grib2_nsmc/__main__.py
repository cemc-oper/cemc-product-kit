...
def serial(
    ...
    from cemc_product_kit.systems.cma_gfs.grib2_nsmc.task_serial import make_grib2_nsmc_by_serial
...
def dask_v1(
    ...
    from cemc_product_kit.systems.cma_gfs.grib2_nsmc.task_dask_v1 import make_grib2_nsmc_by_dask_v1
